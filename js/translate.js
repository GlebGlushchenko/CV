const en = {
    ...
    skils_5: "- Understanding the principles of client-server interaction (HTTP/HTTPS, REST API, WebSocket)",
...
const ru = {
    ...
    skils_5: "- Понимание принципов клиент-серверного взаимодействия (HTTP/HTTPS, REST API, WebSocket)",
