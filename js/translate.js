const en = {
  ...
  skils_5:
    "- Understanding the principles of client-server interaction (HTTP, REST API, WebSocket)",
  skils_6: "- Ability to work with GIT",
  skils_7: "- Responsive and cross-browser layout",
  skils_8:
    "- Layout of web interfaces based on layouts from Figma using BEM methodology and SASS preprocessor",
...
const ru = {
  ...
  skils_5:
    "- Понимание принципов клиент-серверного взаимодействия (HTTP, REST API, WebSocket)",
  skils_6: "- Умение работать с GIT",
  skils_7: "- Адаптивная и кроссбраузерная вёрстка",
  skils_8:
    "- Верстка веб-интерфейсов по макетам из Figma с использованием методологии БЭМ и препроцессора SASS",
